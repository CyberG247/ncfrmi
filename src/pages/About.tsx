      ...
      <section className="bg-muted/40">
        <div className="container-page grid gap-10 py-16 lg:grid-cols-2 lg:items-center">
          <Reveal variant="scale" className="flex flex-col items-center">
            <div className="relative p-8 rounded-full bg-background border border-border shadow-elegant">
              <img src={logo} alt="NCFRMI" className="h-40 w-40 animate-float" width={160} height={160} />
            </div>
          </Reveal>
          <Reveal delay={150}>
      ...
      <section className="container-page py-16">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2">
          {[
            ...
            <Reveal key={y} delay={i * 100} variant="scale">
              <div className="rounded-xl border border-border bg-card p-6 shadow-card hover-glow">
