                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      ...
                      <Field label="State of origin *">
                        <Select value={data.state_origin} onValueChange={(v) => { set("state_origin", v); set("lga", ""); }}>
                      ...
                      <Field label="LGA *">
                        <Select value={data.lga} onValueChange={(v) => set("lga", v)} disabled={!data.state_origin}>
                          <SelectTrigger><SelectValue placeholder="Select LGA" /></SelectTrigger>
                          <SelectContent className="max-h-60">
                            {(data.state_origin && NG_STATES_AND_LGAS[data.state_origin]) ? 
                              NG_STATES_AND_LGAS[data.state_origin].map((lga) => <SelectItem key={lga} value={lga}>{lga}</SelectItem>) 
                              : null}
                          </SelectContent>
                        </Select>
                      </Field>
