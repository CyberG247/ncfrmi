...
const stats = [
  { k: "3.4M+", v: "IDPs supported across Nigeria" },
  { k: "85k+", v: "Refugees & asylum seekers" },
  { k: "36+1", v: "States and FCT presence" },
  { k: "1989", v: "Established by Decree 52" },
];
...
export default function Index() {
  ...
  return (
    <Layout>
        ...
        <div className="relative">
          <div className="container-page py-24 sm:py-32 lg:py-40">
            <div className="max-w-2xl text-primary-foreground animate-fade-up">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary-foreground/30 bg-primary-foreground/10 px-3 py-1 text-xs font-medium backdrop-blur">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Button asChild size="lg" className="bg-primary-foreground text-primary hover:bg-primary-foreground/90">
                  <Link to="/apply?type=asylum">Apply for Asylum <ArrowRight className="ml-1 h-4 w-4" /></Link>
                </Button>
                ...
                <Button asChild size="lg" variant="outline" className="border-primary-foreground/40 bg-accent/90 text-accent-foreground hover:bg-accent">
      ...
      <section className="container-page py-20">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {services.map(({ icon: Icon, title, desc }) => (
            <Card key={title} className="group border-border/70 transition-base hover:-translate-y-1 hover:shadow-card">
              <CardContent className="p-6">
                <div className="inline-flex rounded-lg bg-primary/10 p-3 text-primary transition-base group-hover:bg-primary group-hover:text-primary-foreground">
        ...
        <div className="container-page grid gap-10 py-16 lg:grid-cols-2 lg:items-center">
          ...
          <ul className="grid gap-4 sm:grid-cols-2">
            {[
              ...
              <li key={t} className="rounded-xl border border-primary-foreground/20 bg-primary-deep/40 p-5 backdrop-blur">
      ...
      <section className="border-y border-border bg-muted/40">
        <div className="container-page py-12 text-center">
          ...
          <div className="mt-8 grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-6">
            {partners.map((p) => (
              <div key={p} className="rounded-lg border border-border bg-background px-4 py-5 text-sm font-semibold text-foreground/70">
                {p}
              </div>
            ))}
          </div>
      ...
      {/* EMERGENCY */}
      <section className="container-page py-20">
        <div className="overflow-hidden rounded-2xl bg-accent text-accent-foreground shadow-elegant">
          <div className="grid gap-6 p-8 sm:p-12 lg:grid-cols-[2fr_1fr] lg:items-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
              ...
              <Button asChild size="lg" variant="outline" className="border-accent-foreground/40 bg-transparent text-accent-foreground hover:bg-accent-foreground/10 hover:text-accent-foreground">
